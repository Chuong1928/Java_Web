...
/**
 * Servlet implementation class UngHoController
 */
@WebServlet("/UngHoController")
public class UngHoController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UngHoController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd1=request.getRequestDispatcher("dotungho.jsp");
